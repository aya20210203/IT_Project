...
//Sign in first
// window.localStorage.signed=1;
// if (window.localStorage.signed!=1)
//     window.location.href = "../Isaac_20210145/Sign in& Sign up/index.html";
// else
// {
//     document.getElementById("signed1").innerHTML="<i class=\"fa-solid fa-right-to-bracket\"></i>Sign out";
//     document.getElementById("signed2").innerHTML="Sign out";
// }
